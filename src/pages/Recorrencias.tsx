        ...
        <DialogContent className="max-w-sm max-h-[85vh] overflow-y-auto">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-2">
                <Label>Dia Pagamento</Label>
                <Input type="number" min="1" max="28" value={editForm.dia_referencia ?? ''} onChange={e => { const v = e.target.value; setEditForm(f => ({ ...f, dia_referencia: v === '' ? ('' as any) : Math.min(28, Math.max(1, parseInt(v) || 1)) })); }} onBlur={e => { if (!e.target.value) setEditForm(f => ({ ...f, dia_referencia: 1 })); }} />
              </div>
            </div>
            <div className="space-y-2">
              <Label>Pessoa</Label>
